module "network" {
  ...
  vnet1           = "HUB-SLDR"
  vnet1_space     = ["0.0.0.0/23"]
  
  subnet1         = "CSR-Internal"
  subnet1_space   = ["0.0.0.0/27"]
  nsg1            = "CSR-Internal"
  
  subnet2         = "CSR-External"
  subnet2_space   = ["0.0.0.64/27"]
  nsg2           = "CSR-External"

  subnet3         = "FG-Internal"
  subnet3_space   = ["0.0.0.128/27"]
  nsg3            = "FG-Internal"

#DR Spoke
  dr              = "Spoke-Test"
  vnet2           = "Spoke-Test"
  vnet2_space     = ["0.0.10.0/23"]
  
  subnet01         = "Apps01"
  subnet01_space   = ["0.0.10.0/24"]
  nsg01            = "Apps01"
  rt01             = "SpokeApps01ToHubSLDR"
  
  subnet02         = "Apps02"
  subnet02_space   = ["0.0.11.0/24"]
  nsg02           = "Apps02"
